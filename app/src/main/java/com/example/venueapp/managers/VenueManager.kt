    ...
    suspend fun getVenues(context: Context): VenuesResponse {
        return suspendCoroutine {
            ...
            service.getVenueController().venues(
                    body).enqueue(object : AppCallback<AdvancedAPIResponse<VenuesResponse>>(
                    context) {
                override fun onSuccess(call: Call<AdvancedAPIResponse<VenuesResponse>>,
                        response: Response<AdvancedAPIResponse<VenuesResponse>>) {
